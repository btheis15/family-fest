 ...
 *  - GitHub Pages: the deploy workflow sets PAGES_BASE_PATH="/family-fest",
 *    which switches Next.js to a static export under that subpath. (Custom
 *    headers aren't supported by `output: export`, so they're dropped in that
 *    mode — they don't apply to static hosting anyway.)
 */
