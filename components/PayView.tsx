 ...
 * (the app on mobile, the web profile otherwise) pre-filled with the amount and
 * note, so the actual payment happens in the user's own Venmo account. Zelle
 * has no universal deep link, so we surface the recipient's handle with a copy
 * button + a nudge to open their bank app. No payment credentials live in the
 * app.
 */
