...
const DISMISSED_KEY = "family-fest-dismissed-announcements";
 ...
 * see lib/announcements.ts). Dismissals are remembered per-device.
 */
        ...
        return (
          <div
            ...
            className={`flex items-start gap-3 rounded-2xl p-3 ring-1 ${
              alert ? "bg-primary/10 ring-primary/30" : "bg-card ring-border"
            }`}
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              {a.body && <p className="mt-0.5 text-xs text-foreground/70">{a.body}</p>}
            </div>
            <button
